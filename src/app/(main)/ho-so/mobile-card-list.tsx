      ...
      {rows.map((r) => {
        ...
        return (
          <button
            ...
            className="w-full text-left bg-white rounded-lg shadow-sm border border-slate-100 p-3 active:bg-slate-50"
          >
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                <div className="text-sm font-semibold text-slate-800 truncate">
                  {r.stt}. {r.ho_ten || "(chưa có tên)"}
                </div>
              ...
              <span className={`shrink-0 px-2 py-0.5 rounded-full text-[11px] font-semibold ${BADGE_CLS[status]}`}>
